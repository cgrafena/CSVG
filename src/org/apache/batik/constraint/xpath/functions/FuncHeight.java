...
/**
 * Get the 'height' attribute of the object.
 */
public class FuncHeight extends ConstraintFunction {
    ...
    public XObject execute(XPathContext xpathContext, Vector argVec) {
        ...
        if (xo.getType() == XObject.CLASS_UNKNOWN) {
            ...
            if (o instanceof RectValue) {
                ...
                return new XNumber(rv.getRect().getHeight());
            }
        }
        throw new TypeErrorException("Invalid type passed to function height.");
    }
}
