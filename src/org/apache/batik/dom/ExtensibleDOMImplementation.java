...
public abstract class ExtensibleDOMImplementation
    ...
    protected static synchronized List getDomExtensions() {
        ...
        // xgx: add constraint dom extension
        org.apache.batik.constraint.DOMExtension constraintsExt = new org.apache.batik.constraint.DOMExtension();
        extensions.add((DomExtension)constraintsExt);
        return extensions;
    }
}
